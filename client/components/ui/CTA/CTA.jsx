        ...
        <SectionWrapper id="cta">
            <div className="custom-screen flex flex-col md:flex-row gap-12">
                <div className="max-w-3xl space-y-6 text-gray-600 dark:text-gray-300 flex-1">
                    ...
                    <p>
                        Ready for a try? {""}
                        <Link href="/" className="text-blue-600 hover:text-blue-400 dark:text-sky-500 dark:hover:text-sky-600 inline-flex items-center gap-x-1 duration-150" scroll={false}>
                            Try this
